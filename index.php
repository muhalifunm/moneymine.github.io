  ...
  <div class="container">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <div class="text-center"> <img src="/Moneymindweb/assets/logo.icon" style="max-width:30%;">
          <br>

          <span style="color: Black;">
            <center>
              <h4><B>Money Mind</B></h4>
            </center>
          </span></p>
    ...
    <span style="color: white;">
      <center>
        <h5>Welcome to Money Mind Web!</h5>
      </center>
    </span></p>
